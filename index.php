  ...
  layers: [Basemap,
    new ol.layer.Tile({
     ...
     new ol.layer.Tile({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_PERKANTORAN_PEMPROV/MapServer/info/iteminfo',
			visible: true
	 }),
     new ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_PERMUKIMAN/MapServer/info/iteminfo',
			visible: true
	 })
  ],
  target: 'map',
